...
namespace StringCalculator.Tests
{
    ...
    public class CalculatorConsoleTests
    {
        ...
        private static StringCalculatorConsole1 CreateCalcConsole(Mock<IConsole> mockConsole)
        {
            return new StringCalculatorConsole1(new Mock<IStringCalculator>().Object, mockConsole.Object);
        }

        private static StringCalculatorConsole1 CreateCalcConsole(Mock<IStringCalculator> mockCalculator, Mock<IConsole> mockConsole)
        {
            return new StringCalculatorConsole1(mockCalculator.Object,
                                               mockConsole.Object);
        }
    }
}
