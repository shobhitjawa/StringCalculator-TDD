...
namespace StringCalculator
{
    public class StringCalculator : IStringCalculator
    {
        ...
        private readonly DelimiterParser1 _delimiterParser;

        public StringCalculator()
        {
            this._console = new ConsoleWrapper1();
            this._delimiterParser = new SubStringDelimiterParser();
        }

        public StringCalculator(IConsole console, DelimiterParser1 delimiterParser)
        {
